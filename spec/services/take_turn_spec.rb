    ...
    context "when the player is allowed to move" do
      ...
      context "when only one jump step is required to complete a turn and there are no forward facing enemies" do
        ...
        it "applies the step and returns the new game state without errors" do
          ...
          expect(service.game_state.board.layout).to eql [ConstructBoard::Square.new(1, "red", [5, 6]), ConstructBoard::Square.new(2, "red", [6, 7]), ConstructBoard::Square.new(3, "red", [7, 8]), ConstructBoard::Square.new(4, "red", [8]), ConstructBoard::Square.new(5, "red", [1, 9]), ConstructBoard::Square.new(6, "red", [1, 2, 9, 10]), ConstructBoard::Square.new(7, "red", [2, 3, 10, 11]), ConstructBoard::Square.new(8, "red", [3, 4, 11, 12]), ConstructBoard::Square.new(9, "red", [5, 6, 13, 14]), ConstructBoard::Square.new(10, "empty", [6, 7, 14, 15]), ConstructBoard::Square.new(11, "empty", [7, 8, 15, 16]), ConstructBoard::Square.new(12, "empty", [8, 16]), ConstructBoard::Square.new(13, "empty", [9, 17]), ConstructBoard::Square.new(14, "red", [9, 10, 17, 18]), ConstructBoard::Square.new(15, "white", [10, 11, 18, 19]), ConstructBoard::Square.new(16, "red", [11, 12, 19, 20]), ConstructBoard::Square.new(17, "empty", [13, 14, 21, 22]), ConstructBoard::Square.new(18, "empty", [14, 15, 22, 23]), ConstructBoard::Square.new(19, "empty", [15, 16, 23, 24]), ConstructBoard::Square.new(20, "empty", [16, 24]), ConstructBoard::Square.new(21, "white", [17, 25]), ConstructBoard::Square.new(22, "white", [17, 18, 25, 26]), ConstructBoard::Square.new(23, "white", [18, 19, 26, 27]), ConstructBoard::Square.new(24, "empty", [19, 20, 27, 28]), ConstructBoard::Square.new(25, "white", [21, 22, 29, 30]), ConstructBoard::Square.new(26, "white", [22, 23, 30, 31]), ConstructBoard::Square.new(27, "white", [23, 24, 31, 32]), ConstructBoard::Square.new(28, "white", [24, 32]), ConstructBoard::Square.new(29, "white", [25]), ConstructBoard::Square.new(30, "white", [25, 26]), ConstructBoard::Square.new(31, "white", [26, 27]), ConstructBoard::Square.new(32, "white", [27, 28])]
        end
      end
      ...
      context "when multiple jump steps are required to complete a turn" do
        ...
        context "when more jumps are still pending" do
          ...
          it "applies the step, but keeps curent player same and returns an error" do
            ...
            expect(service.game_state.current_player).to eq player_two
            expect(service.game_state.board.layout).to eql [ConstructBoard::Square.new(1, "red", [5, 6]), ConstructBoard::Square.new(2, "red", [6, 7]), ConstructBoard::Square.new(3, "red", [7, 8]), ConstructBoard::Square.new(4, "red", [8]), ConstructBoard::Square.new(5, "red", [1, 9]), ConstructBoard::Square.new(6, "red", [1, 2, 9, 10]), ConstructBoard::Square.new(7, "red", [2, 3, 10, 11]), ConstructBoard::Square.new(8, "empty", [3, 4, 11, 12]), ConstructBoard::Square.new(9, "red", [5, 6, 13, 14]), ConstructBoard::Square.new(10, "red", [6, 7, 14, 15]), ConstructBoard::Square.new(11, "red", [7, 8, 15, 16]), ConstructBoard::Square.new(12, "red", [8, 16]), ConstructBoard::Square.new(13, "empty", [9, 17]), ConstructBoard::Square.new(14, "empty", [9, 10, 17, 18]), ConstructBoard::Square.new(15, "white", [10, 11, 18, 19]), ConstructBoard::Square.new(16, "empty", [11, 12, 19, 20]), ConstructBoard::Square.new(17, "empty", [13, 14, 21, 22]), ConstructBoard::Square.new(18, "empty", [14, 15, 22, 23]), ConstructBoard::Square.new(19, "empty", [15, 16, 23, 24]), ConstructBoard::Square.new(20, "empty", [16, 24]), ConstructBoard::Square.new(21, "white", [17, 25]), ConstructBoard::Square.new(22, "white", [17, 18, 25, 26]), ConstructBoard::Square.new(23, "white", [18, 19, 26, 27]), ConstructBoard::Square.new(24, "empty", [19, 20, 27, 28]), ConstructBoard::Square.new(25, "white", [21, 22, 29, 30]), ConstructBoard::Square.new(26, "white", [22, 23, 30, 31]), ConstructBoard::Square.new(27, "white", [23, 24, 31, 32]), ConstructBoard::Square.new(28, "white", [24, 32]), ConstructBoard::Square.new(29, "white", [25]), ConstructBoard::Square.new(30, "white", [25, 26]), ConstructBoard::Square.new(31, "white", [26, 27]), ConstructBoard::Square.new(32, "white", [27, 28])]
          end
        end
      end
    end
