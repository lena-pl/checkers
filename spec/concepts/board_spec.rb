...
RSpec.describe Board do
  ...
  describe "#layout" do
    it "returns an array of square structs" do
      ...
      expect(subject.layout).to eql [square_one, square_two, square_three]
    end
  end
  ...
  describe "#active_pieces_count" do
    ...
    it "returns the count of white pieces on the board" do
      expect(subject.active_pieces_count(player_two)).to eql 1
    end
  end
end
