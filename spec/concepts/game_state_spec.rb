...
RSpec.describe GameState do
  ...
  context "when the game is over and red won" do
    let(:positions_and_occupants) { [[1, "red"], [2, "red"], [3, "red"], [4, "red"], [5, "red"], [6, "red"], [7, "red"], [8, "red"], [9, "red"], [10, "red"], [11, "red"], [12, "red"], [13, "empty"], [14, "empty"], [15, "empty"], [16, "empty"], [17, "empty"], [18, "empty"], [19, "empty"], [20, "empty"], [21, "empty"], [22, "empty"], [23, "empty"], [24, "empty"], [25, "empty"], [26, "empty"], [27, "empty"], [28, "empty"], [29, "empty"], [30, "empty"], [31, "empty"], [32, "empty"]] }
  ...
  context "when the game is over and is a draw" do
    let(:positions_and_occupants) { [[1, "white"], [2, "empty"], [3, "empty"], [4, "empty"], [5, "empty"], [6, "empty"], [7, "empty"], [8, "empty"], [9, "empty"], [10, "empty"], [11, "empty"], [12, "empty"], [13, "empty"], [14, "empty"], [15, "empty"], [16, "empty"], [17, "empty"], [18, "empty"], [19, "empty"], [20, "empty"], [21, "empty"], [22, "empty"], [23, "empty"], [24, "empty"], [25, "empty"], [26, "empty"], [27, "empty"], [28, "empty"], [29, "empty"], [30, "empty"], [31, "empty"], [32, "red"]] }
